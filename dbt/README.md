...
dbt compile --select=tabela_exemplo --project-dir=$(pwd)/demo_mysql --profiles-dir=$(pwd)/profiles
dbt run --select=tabela_exemplo --project-dir=$(pwd)/demo_mysql --profiles-dir=$(pwd)/profiles
dbt run --debug --select=tabela_exemplo --project-dir=$(pwd)/demo_mysql --profiles-dir=$(pwd)/profiles
